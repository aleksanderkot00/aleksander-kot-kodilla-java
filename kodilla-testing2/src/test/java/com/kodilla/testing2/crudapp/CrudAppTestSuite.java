...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://aleksanderkot00.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("aleksanderkot00@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("kodillaTrelloPass");
